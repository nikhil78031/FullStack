...
function Profile() {
    ...
    return (
        <div className="profilePageContainer">
            ...
            {authState.username === username && <button onClick={()=>{history.push("/changepassword")}}>Change My Password</button>}</div>
            ...
            { listofposts.map((value,key)=>{
                ...
                <div className="footer" > <div className="username">{value.username}</div> <div className="buttons">  
